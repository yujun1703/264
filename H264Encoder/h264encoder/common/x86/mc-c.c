...
extern "C"     void func##_mmx2 args;\
extern "C"     void func##_sse2 args;\
extern "C"     void func##_ssse3 args;
...
extern "C"  void x264_mc_weight_w##w##_##type( pixel *, intptr_t, pixel *, intptr_t, const x264_weight_t *, int );

#define MC_WEIGHT_OFFSET(w,type) \
extern "C"     void x264_mc_offsetadd_w##w##_##type( pixel *, intptr_t, pixel *, intptr_t, const x264_weight_t *, int ); \
extern "C"     void x264_mc_offsetsub_w##w##_##type( pixel *, intptr_t, pixel *, intptr_t, const x264_weight_t *, int ); \
    MC_WEIGHT(w,type)
...
extern "C" void x264_mc_copy_w4_mmx  ( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_mc_copy_w8_mmx  ( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_mc_copy_w8_sse2 ( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_mc_copy_w16_mmx ( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_mc_copy_w16_sse2( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_mc_copy_w16_aligned_sse2( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_prefetch_fenc_420_mmx2( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_prefetch_fenc_422_mmx2( pixel *, intptr_t, pixel *, intptr_t, int );
extern "C" void x264_prefetch_ref_mmx2( pixel *, intptr_t, int );
extern "C" void x264_plane_copy_core_mmx2( pixel *, intptr_t, pixel *, intptr_t, int w, int h );
extern void x264_plane_copy_c( pixel *, intptr_t, pixel *, intptr_t, int w, int h );
extern "C" void x264_plane_copy_interleave_core_mmx2( pixel *dst,  intptr_t i_dst,
                                           pixel *srcu, intptr_t i_srcu,
                                           pixel *srcv, intptr_t i_srcv, int w, int h );
extern "C" void x264_plane_copy_interleave_core_sse2( pixel *dst,  intptr_t i_dst,
                                           pixel *srcu, intptr_t i_srcu,
                                           pixel *srcv, intptr_t i_srcv, int w, int h );
extern "C" void x264_plane_copy_interleave_core_avx( pixel *dst,  intptr_t i_dst,
                                          pixel *srcu, intptr_t i_srcu,
                                          pixel *srcv, intptr_t i_srcv, int w, int h );
extern void x264_plane_copy_interleave_c( pixel *dst,  intptr_t i_dst,
                                   pixel *srcu, intptr_t i_srcu,
                                   pixel *srcv, intptr_t i_srcv, int w, int h );
extern "C" void x264_plane_copy_deinterleave_mmx( pixel *dstu, intptr_t i_dstu,
                                       pixel *dstv, intptr_t i_dstv,
                                       pixel *src,  intptr_t i_src, int w, int h );
extern "C" void x264_plane_copy_deinterleave_sse2( pixel *dstu, intptr_t i_dstu,
                                        pixel *dstv, intptr_t i_dstv,
                                        pixel *src,  intptr_t i_src, int w, int h );
extern "C" void x264_plane_copy_deinterleave_ssse3( uint8_t *dstu, intptr_t i_dstu,
                                         uint8_t *dstv, intptr_t i_dstv,
                                         uint8_t *src,  intptr_t i_src, int w, int h );
extern "C" void x264_plane_copy_deinterleave_avx( uint16_t *dstu, intptr_t i_dstu,
                                       uint16_t *dstv, intptr_t i_dstv,
                                       uint16_t *src,  intptr_t i_src, int w, int h );
extern "C" void x264_store_interleave_chroma_mmx2( pixel *dst, intptr_t i_dst, pixel *srcu, pixel *srcv, int height );
extern "C" void x264_store_interleave_chroma_sse2( pixel *dst, intptr_t i_dst, pixel *srcu, pixel *srcv, int height );
extern "C" void x264_store_interleave_chroma_avx ( pixel *dst, intptr_t i_dst, pixel *srcu, pixel *srcv, int height );
extern "C" void x264_load_deinterleave_chroma_fenc_mmx ( pixel *dst, pixel *src, intptr_t i_src, int height );
extern "C" void x264_load_deinterleave_chroma_fenc_sse2( pixel *dst, pixel *src, intptr_t i_src, int height );
extern "C" void x264_load_deinterleave_chroma_fenc_ssse3( uint8_t *dst, uint8_t *src, intptr_t i_src, int height );
extern "C" void x264_load_deinterleave_chroma_fenc_avx( uint16_t *dst, uint16_t *src, intptr_t i_src, int height );
extern "C" void x264_load_deinterleave_chroma_fdec_mmx ( pixel *dst, pixel *src, intptr_t i_src, int height );
extern "C" void x264_load_deinterleave_chroma_fdec_sse2( pixel *dst, pixel *src, intptr_t i_src, int height );
extern "C" void x264_load_deinterleave_chroma_fdec_ssse3( uint8_t *dst, uint8_t *src, intptr_t i_src, int height );
extern "C" void x264_load_deinterleave_chroma_fdec_avx( uint16_t *dst, uint16_t *src, intptr_t i_src, int height );
extern "C" void *x264_memcpy_aligned_mmx ( void *dst, const void *src, size_t n );
extern "C" void *x264_memcpy_aligned_sse2( void *dst, const void *src, size_t n );
extern "C" void x264_memzero_aligned_mmx ( void *dst, size_t n );
extern "C" void x264_memzero_aligned_sse2( void *dst, size_t n );
extern "C" void x264_integral_init4h_sse4( uint16_t *sum, uint8_t *pix, intptr_t stride );
extern "C" void x264_integral_init8h_sse4( uint16_t *sum, uint8_t *pix, intptr_t stride );
extern "C" void x264_integral_init8h_avx ( uint16_t *sum, uint8_t *pix, intptr_t stride );
extern "C" void x264_integral_init4v_mmx  ( uint16_t *sum8, uint16_t *sum4, intptr_t stride );
extern "C" void x264_integral_init4v_sse2 ( uint16_t *sum8, uint16_t *sum4, intptr_t stride );
extern "C" void x264_integral_init4v_ssse3( uint16_t *sum8, uint16_t *sum4, intptr_t stride );
extern "C" void x264_integral_init8v_mmx ( uint16_t *sum8, intptr_t stride );
extern "C" void x264_integral_init8v_sse2( uint16_t *sum8, intptr_t stride );
extern "C" void x264_mbtree_propagate_cost_sse2( int *dst, uint16_t *propagate_in, uint16_t *intra_costs,
                                      uint16_t *inter_costs, uint16_t *inv_qscales, float *fps_factor, int len );
extern "C" void x264_mbtree_propagate_cost_avx ( int *dst, uint16_t *propagate_in, uint16_t *intra_costs,
                                      uint16_t *inter_costs, uint16_t *inv_qscales, float *fps_factor, int len );
extern "C" void x264_mbtree_propagate_cost_fma4( int *dst, uint16_t *propagate_in, uint16_t *intra_costs,
                                      uint16_t *inter_costs, uint16_t *inv_qscales, float *fps_factor, int len );

#define MC_CHROMA(cpu)\
extern "C" void x264_mc_chroma_##cpu( pixel *dstu, pixel *dstv, intptr_t i_dst, pixel *src, intptr_t i_src,\
...
#define LOWRES(cpu)\
extern "C" void x264_frame_init_lowres_core_##cpu( pixel *src0, pixel *dst0, pixel *dsth, pixel *dstv, pixel *dstc,\
...
extern "C" void x264_pixel_avg2_w##width##_##cpu( pixel *, intptr_t, pixel *, intptr_t, pixel *, intptr_t );
...
extern "C" void x264_hpel_filter_v_##cpuv( pixel *dst, pixel *src, int16_t *buf, intptr_t stride, intptr_t width);\
extern "C" void x264_hpel_filter_c_##cpuc( pixel *dst, int16_t *buf, intptr_t width );\
extern "C" void x264_hpel_filter_h_##cpuh( pixel *dst, pixel *src, intptr_t width );\
