...
EXTERNFLAG  void x264_cabac_encode_decision_asm( x264_cabac_t *cb, int i_ctx, int b );
EXTERNFLAG  void x264_cabac_encode_bypass_asm( x264_cabac_t *cb, int b );
EXTERNFLAG  void x264_cabac_encode_terminal_asm( x264_cabac_t *cb );
#else
#if HAVE_ARMV6 //added by sensong 201404
