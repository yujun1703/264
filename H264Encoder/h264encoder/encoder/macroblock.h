...
#if RC_MAD
static ALWAYS_INLINE void x264_mb_encode_i4x4( x264_t *h, int p, int idx, int i_qp, int i_mode, int b_predict, int encode )
#else
...
//	dctcoef __declspec(align(16)) dct8x8[64];
//	pixel __declspec(align(32)) edge_buf[36];
    dctcoef DECLARE_ALIGNED(dct8x8[64],16);
    pixel DECLARE_ALIGNED(edge_buf[36],16);
