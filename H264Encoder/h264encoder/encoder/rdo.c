...
static inline int ssd_mb( x264_t *h )
{
    ...
    chroma_ssd = (int)( ((uint64_t)chroma_ssd * h->mb.i_chroma_lambda2_offset + 128) >> 8 );
...
static int x264_rd_cost_mb( x264_t *h, int i_lambda2 )
{
    ...
    else if( h->param.b_cabac )
    {
        ...
        i_bits = (int)( ( (uint64_t)cabac_tmp.f8_bits_encoded * i_lambda2 + 32768 ) >> 16 );
    }
    else
    {
...
static uint64_t x264_rd_cost_subpart( x264_t *h, int i_lambda2, int i4, int i_pixel )
{
    ...
    if( CHROMA444 )
    {
        ...
        chromassd = (int) ( ((uint64_t)chromassd * h->mb.i_chroma_lambda2_offset + 128) >> 8 );
        i_ssd += chromassd;
    }
...
static uint64_t x264_rd_cost_i4x4( x264_t *h, int i_lambda2, int i4, int i_mode )
{
    ...
    {
#if RC_MAD
		x264_mb_encode_i4x4( h, p, i4, i_qp, i_mode, 1 ,0);
#else
