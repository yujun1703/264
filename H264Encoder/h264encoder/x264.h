...
#define X264_CPU_ARMV8           0x40000000  
...
{
	//added by fred
    temporal_levle_idc curr_level;
    temporal_levle_idc ref_level;
...
void x264_encoder_set_period(x264_t *, int, int, int);

void x264_encoder_reset_rc_buffer(x264_t *);
void x264_encoder_set_delaytime(x264_t *, int);
...
int     x264_encoder_reset_esolution( x264_t *, int, int );
...
#define H264ENCODERVER     2012070600
