...
static int video_get_buffer(AVCodecContext *s, AVFrame *pic)
{
    ...
    if (!buf->base[0]) 
	{
        ...
        const int pixel_size = av_pix_fmt_descriptors[0].comp[0].step_minus1+1;
...
//               pic->width, pic->height, "yuv420p", s->width, s->height, "yuv420p");
