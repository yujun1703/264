...
////*/{"h264", NULL, 0, AV_OPT_TYPE_CONST, /*{.dbl = FF_IDCT_H264 }*/FF_IDCT_H264, INT_MIN, INT_MAX, V|E|D, "idct"},
...
////////    OFFSET(log_level_offset),/*.log_level_offset_offset = */
