 ...
 * modify it the terms of the GNU Lesser General Public
...
void ff_pred4x4_dc_10_mmxext (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_down_left_10_sse2 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_down_left_10_avx (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_down_right_10_sse2 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_down_right_10_ssse3 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_down_right_10_avx (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_vertical_left_10_sse2 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_vertical_left_10_avx (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_vertical_right_10_sse2 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_vertical_right_10_ssse3 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_vertical_right_10_avx (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_horizontal_up_10_mmxext (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_horizontal_down_10_sse2 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_horizontal_down_10_ssse3 (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred4x4_horizontal_down_10_avx (uint8_t *src, const uint8_t *topright, int stride);
void ff_pred8x8_dc_10_mmxext (uint8_t *src, int stride);
void ff_pred8x8_dc_10_sse2 (uint8_t *src, int stride);
void ff_pred8x8_top_dc_10_sse2 (uint8_t *src, int stride);
void ff_pred8x8_plane_10_sse2 (uint8_t *src, int stride);
void ff_pred8x8_vertical_10_sse2 (uint8_t *src, int stride);
void ff_pred8x8_horizontal_10_sse2 (uint8_t *src, int stride);
void ff_pred8x8l_dc_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_dc_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_128_dc_10_mmxext (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_128_dc_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_top_dc_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_top_dc_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_vertical_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_vertical_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_horizontal_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_horizontal_10_ssse3 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_horizontal_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_down_left_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_down_left_10_ssse3 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_down_left_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_down_right_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_down_right_10_ssse3 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_down_right_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_vertical_right_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_vertical_right_10_ssse3 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_vertical_right_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_horizontal_up_10_sse2 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_horizontal_up_10_ssse3 (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred8x8l_horizontal_up_10_avx (uint8_t *src, int has_topleft, int has_topright, int stride);
void ff_pred16x16_dc_10_mmxext (uint8_t *src, int stride);
void ff_pred16x16_dc_10_sse2 (uint8_t *src, int stride);
void ff_pred16x16_top_dc_10_mmxext (uint8_t *src, int stride);
void ff_pred16x16_top_dc_10_sse2 (uint8_t *src, int stride);
void ff_pred16x16_128_dc_10_mmxext (uint8_t *src, int stride);
void ff_pred16x16_128_dc_10_sse2 (uint8_t *src, int stride);
void ff_pred16x16_left_dc_10_mmxext (uint8_t *src, int stride);
void ff_pred16x16_left_dc_10_sse2 (uint8_t *src, int stride);
void ff_pred16x16_vertical_10_mmxext (uint8_t *src, int stride);
void ff_pred16x16_vertical_10_sse2 (uint8_t *src, int stride);
void ff_pred16x16_horizontal_10_mmxext (uint8_t *src, int stride);
void ff_pred16x16_horizontal_10_sse2 (uint8_t *src, int stride);
...
#endif //SUPPORT_BIT10 bit_depth==10
