...
int ff_h264_decode_seq_parameter_set(H264Context *h){
    ...
    reserved = get_bits(&s->gb, 2); // reserved
	reserved = reserved &0x3;		// get last 2bit
	...
	sps->reserved_zero_2bits  = reserved;
	...
	//printf("\n\n\n\t---------------------------------Mode: %s\n", sps->reserved_zero_2bits ==0?"standard":"define");
	h->hasIDRflag = 0;	// set hasIDRflag =0
	...
	{
		static char* format[] = {"Gray","420","422","444"}; 
