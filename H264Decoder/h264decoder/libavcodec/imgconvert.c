...
//static const PixFmtInfo pix_fmt_info[ 1 ] = {
//    /* YUV formats */
//    {FF_COLOR_YUV, 0}
//};
...
{
    *h_shift = av_pix_fmt_descriptors[0].log2_chroma_w;
    *v_shift = av_pix_fmt_descriptors[0].log2_chroma_h;
}

//int ff_is_hwaccel_pix_fmt(enum PixelFormat pix_fmt)
//{
//    return av_pix_fmt_descriptors[0].flags & PIX_FMT_HWACCEL;
//}
...
//{
//    const AVPixFmtDescriptor *desc = &av_pix_fmt_descriptors[0];
//    int i;
//
...
//        return ~0;
//
//    src_desc = &av_pix_fmt_descriptors[0];
//    dst_desc = &av_pix_fmt_descriptors[0];
