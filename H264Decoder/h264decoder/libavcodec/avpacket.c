...
////    //    for (i=1; ; i++){
////    //        size = AV_RB32(p);
////    //        if (size>INT_MAX || p - pkt->data <= (uint8_t)size)
////    //            return 0;
////    //        if (p[4]&128)
////    //            break;
////    //        p-= size+5;
...
////    //    {
////    //        size= AV_RB32(p);
////    //        //av_assert0(size<=INT_MAX && p - pkt->data > (uint8_t)size);//return 0;
////    //        if ( !(size<=INT_MAX && p - pkt->data > (uint8_t)size) ) return 0;
