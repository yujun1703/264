...
// Start nal_ref_idc
#define NAL_REF_IDC_IDR_GF		2
#define NAL_REF_IDC_SP_NOSP		1
#define NAL_REF_IDC_PWITHSP		0
// End added by sensong 20120529
...
typedef struct SPS{
	...
	int reserved_zero_2bits;		   ///< reserver_zero_4bits,0 for standard;1 for our defined mode by sensong 20120525
}SPS;
...
//=============================================================
    ...
    int parse_last_mb;
	// start
#define H264_MODE_STANDARD				1
#define H264_MODE_OURDEFINE				0
	int h264StandardFlag;				// 1:standard; 0 our define	
	int coded_h264StandardFlag;			// old flag used when bitstream mode changed.
	int hasIDRflag;
	// end added by sensong
}H264Context;
