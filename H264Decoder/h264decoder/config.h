...
//#define FF_MEMORY_MONITOR	// ±àÒë¿ØÖÆ¿ª¹Ø

#define SUPPORT_BIT10 0
// Shut-down all X86 codes for iOS
#if (TARGET_OS_IPHONE && TARGET_OS_MAC) || (ANDROID)
#define run_mode 0      // 0 run in c 1 run in mmx
#else
#define run_mode 1      // 0 run in c 1 run in mmx
#endif
#define HAVE_H264DSPContext     1 //diff
#define HAVE_H264PredContext    1 //
#define HAVE_DSPContext         1 //
...
#define ARCH_TOMI 0
#define ARCH_X86 run_mode
#define ARCH_X86_32 run_mode
#define ARCH_X86_64 0

#define HAVE_YASM run_mode
#define HAVE_INLINE_ASM run_mode
#define HAVE_AVX 0
#define HAVE_MMI 0
#define HAVE_MMX run_mode
#define HAVE_MMX2 run_mode
#define HAVE_SSE run_mode
#define HAVE_SSSE3 run_mode

#define HAVE_AMD3DNOW run_mode
#define HAVE_AMD3DNOWEXT run_mode
